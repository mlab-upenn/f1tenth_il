...
class PPO(object):
    ...
    def load(self, episode):
        self.critic.load_state_dict(torch.load("./rl_model/ppo_critic{}.pth".format(episode)))
        self.actor.load_state_dict(torch.load("./rl_model/ppo_actor{}.pth".format(episode)))
